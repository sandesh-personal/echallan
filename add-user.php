                                ...
                                <form action="saveuser.php" method="post">
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="username" class="form-control" placeholder="Username" minlength="2">
                                        </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" name="pass" class="form-control" placeholder="Password" minlength="5">
                                        </div>
                                        </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control" placeholder="Full Name" minlength="5">
                                        </div>
                                    </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Address</label>
                                                <input type="text" name="address"  class="form-control" placeholder="Home Address" minlength="2">
                                            </div>
                                        </div>
                                    </div>
